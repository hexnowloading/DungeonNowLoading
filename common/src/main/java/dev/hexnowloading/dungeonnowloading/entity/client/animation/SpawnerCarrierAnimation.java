...
public class SpawnerCarrierAnimation {
    public static final AnimationDefinition SPAWNER_CARRIER_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
            ...
            .addAnimation("eye", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 2.2F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0833F, KeyframeAnimations.posVec(0.0F, -0.2F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 2.2F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .build();

    public static final AnimationDefinition SPAWNER_CARRIER_ATTACK = AnimationDefinition.Builder.withLength(1.5F)
            .addAnimation("leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(0.5F, KeyframeAnimations.degreeVec(13.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            new Keyframe(0.1667F, KeyframeAnimations.scaleVec(0.6F, 0.6F, 0.6F), AnimationChannel.Interpolations.CATMULLROM),
