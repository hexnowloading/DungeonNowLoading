...
public class ScuttleAnimation {
    public static final AnimationDefinition SCUTTLE_WAKING_UP = AnimationDefinition.Builder.withLength(3.625F)
    ...
    public static final AnimationDefinition SCUTTLE_MOUTH_OPEN = AnimationDefinition.Builder.withLength(1.5417F)
    ...
    public static final AnimationDefinition SCUTTLE_MOUTH_CLOSE = AnimationDefinition.Builder.withLength(1.375F)
            .addAnimation("flame_thrower", new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition SCUTTLE_IDLE_CLOSED = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("upper", new AnimationChannel(AnimationChannel.Targets.POSITION,
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition SCUTTLE_IDLE_OPENED = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("flame_thrower", new AnimationChannel(AnimationChannel.Targets.POSITION,
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 2.2F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition SCUTTLE_WALKING_CLOSED = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition SCUTTLE_BLOCK_FORM = AnimationDefinition.Builder.withLength(0.5417F).looping()
		.addAnimation("right_back_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
